...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $cake1 = $_POST["cupcake1"];
    $cake2 = $_POST["cupcake2"];
    $cake3 = $_POST["cupcake3"];
    $cake4 = $_POST["cupcake4"];
    $cake5 = $_POST["cupcake5"];
    $cake6 = $_POST["cupcake6"];
    ...
    $x1="INSERT INTO cupcakes (first,second,third,fourth,fifth,sixth) VALUES ($cake1,$cake2,$cake3,$cake4,$cake5,$cake6)";
    $y1=$conn->query($x1);
